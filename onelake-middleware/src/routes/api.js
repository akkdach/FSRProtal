...
router.post('/manpower', (req, res) => fsrProtalControllerSql.createManpower(req, res));
router.put('/manpower/:no', (req, res) => fsrProtalControllerSql.updateManpower(req, res));
router.delete('/manpower/:no', (req, res) => fsrProtalControllerSql.deleteManpower(req, res));
